...
enum RouterVersion {
  AriswapV2Router01 = 'AriswapV2Router01',
  AriswapV2Router02 = 'AriswapV2Router02'
}

describe('AriswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.AriswapV2Router01]: fixture.router01,
        [RouterVersion.AriswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.AriswapV2Router01]: 101876,
              [RouterVersion.AriswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.AriswapV2Router01]: 138770,
              [RouterVersion.AriswapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
